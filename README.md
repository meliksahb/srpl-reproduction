...
explore the state space* — reproduced directly. Figure:
`figures/fig1_pond.png`.
...
Full per-condition numbers: [`figures/table1.md`](figures/table1.md);
training curves: `figures/fig4_<task>_<algo>.png` (6 plots).
...
(~13.4–14.3, fully overlapping bands; see
